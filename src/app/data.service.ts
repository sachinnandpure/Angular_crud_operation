...
export class DataService {
  ...
  getProduct(id: number): Observable<UserFetch> {
    ...
    addProduct (user: UserFetch): Observable<UserFetch> {
      user.id=null;
  ...
  deleteProduct(id: number): Observable<UserFetch> {
    const url = `${this.apiurl}/${id}`;
  ...
  updateProduct(user: UserFetch): Observable<UserFetch>{
